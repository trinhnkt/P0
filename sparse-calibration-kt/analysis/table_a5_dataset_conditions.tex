...
\midrule
Sufficient test support & Partial (sparse $N=403$ L; very-sparse $N=19$ I) & Absent (0 sparse/very-sparse test events) & Present (sparse $N=2,002$ R; very-sparse $N=109$ L) \\
\midrule
...
\midrule
Observed calibration gradient (SimpleKT, event-level) & Monotonic increase (0.113$\to$0.158$\to$0.225) & Dense$\to$medium only ($\Delta$ECE$=+0.031$); sparse empty & Flat dense$\to$sparse (0.115$\to$0.112$\to$0.124) \\
\bottomrule
\end{tabularx}
