...
\vspace{1ex}
{\scriptsize \textbf{Note:} Low/Moderate/High describe the priority of \emph{sparse-concept diagnostic claims}, not whether the protocol should be run. Occupancy reporting (empty buckets, reliability flags) is useful hygiene on every split we consider.\par}
\end{table*}
